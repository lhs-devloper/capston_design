...
def get_stats(link):
    ...
    for i in range(3, 100):
        ...
        if "," in team:
            team = team.replace(",", "|")
        basestat_List = f"{year}, {team}, {age}, {g}, {pa}, {ab}, {r}, {hit}, {hit_2}, {hit_3}, {home_run}, {base}, {rbi}, {sb}, {cs}, {hbp}, {ibb}, {so}, {gdp}, {sh}, {sf}, {avg}, {obp}, {slg}, {ops}, {woba}, {wrc}\n"
...
# 타격 http://www.statiz.co.kr/stat_at.php?re=0&lr=
